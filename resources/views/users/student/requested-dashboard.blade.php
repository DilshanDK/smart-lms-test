...
@section('title', 'Student Registration Pending - Smart LMS')
...
@section('content')
    <div id="student-pending-dashboard">
        <!-- Loading State -->
        ...
        <div id="pending-content" style="display: none;">
            <div class="dashboard-header">
                <div class="container">
                    <h1 class="dashboard-title">Registration Under Review</h1>
                    <p class="dashboard-subtitle">Your student application is being processed</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="pending-container">
                    ...
                    <h2 style="color: var(--foreground); margin-bottom: 1rem;">Student Registration Submitted</h2>
                    <p style="color: var(--muted-foreground); margin-bottom: 2rem; font-size: 1.1rem;">
                        Thank you for submitting your student registration! Your application is currently being reviewed by our
                        academic team.
                    </p>
                    ...
                    <div class="status-card">
                        ...
                        <p><strong>Expected Response:</strong> Within 2-3 business days</p>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <ul style="text-align: left; color: var(--muted-foreground);">
                            <li>Our academic team will review your application</li>
                            <li>You'll receive an email notification once approved</li>
                            <li>Access to courses and learning materials will be granted</li>
                            <li>You can start enrolling in available courses</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="declined-content" style="display: none;">
            <div class="dashboard-header" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);">
                <div class="container">
                    ...
                    <p class="dashboard-subtitle">Your student application has been reviewed</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="pending-container">
                    ...
                    <p style="color: var(--muted-foreground); margin-bottom: 2rem; font-size: 1.1rem;">
                        Unfortunately, your student registration application has been declined by our academic team.
                    </p>
                    ...
                    <div class="info-card">
                        ...
                        <ul style="text-align: left; color: var(--muted-foreground);">
                            <li>Contact our academic office for clarification</li>
                            <li>Request feedback on your application</li>
                            <li>Ask about reapplication procedures</li>
                            <li>Discuss alternative pathways or requirements</li>
                        </ul>
